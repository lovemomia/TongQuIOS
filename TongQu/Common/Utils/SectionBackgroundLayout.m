...
-(NSMutableArray *)sectionInsetsArray
{
    if(!_sectionInsetsArray) {
        _sectionInsetsArray = [[NSMutableArray alloc] init];
    }
    return _sectionInsetsArray;
}
...
- (void)prepareLayout
{
    ...
    for (int section=0; section<numberOfSection; section++)
    {
        ...
        NSValue * sectionInsetValue = [self.sectionInsetsArray objectAtIndex:section];
        
        self.sectionInset = [sectionInsetValue UIEdgeInsetsValue];
